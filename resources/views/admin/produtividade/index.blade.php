                    ...
                    <div class="row">
                        ...
                        <div style="font-size: 14px; vertical-align: middle; padding-left 10px; padding-top: 10px;">
                            <i class="fa fa-info-circle"></i>
                             ...
                             O intervalo de datas máximo permitido é 31 dias, por questões de desempenho.
                             <p></p>
                             <i class="fa-solid fa-circle-question"></i>
                             MMR é um termo utilizado nos jogos para indicar um rankeamento dos jogadores
                             afim de tornar as partidas mais "justas". Pegamos emprestado o termo MMR
                             para indicar um valor gerado por uma fórmula matemática que leva em consideração
                             o grau de dificuldade da O.S. e o tempo para sua conclusão.
                        </div>
                    </div>
                </h1>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card" style="overflow-x: auto;">
                    <div class="card-body">
                        <div class="col-sm-12">
                            <form action="{{ route('admin.produtividade.index') }}" method="GET" >
